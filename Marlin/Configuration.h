...
#define STRING_VERSION_CONFIG_H __DATE__ "2016-03-04 22:55" __TIME__ // build date and time
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {43.956,43.956,2642.4242,760*1.1*2.5*0.834}  // default steps per unit for RepMan3.2
